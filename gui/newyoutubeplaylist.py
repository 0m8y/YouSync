...
class NewYoutubePlaylist(customtkinter.CTkFrame):
    ...
    def setup_ui(self):
        ...
        self.back_button = customtkinter.CTkButton(self, text="", command=self.parent_app.go_back, height=45, width=45, image=self.back_ctk_image, fg_color=("#bdbdbd", "#333333"), hover_color=("gray70", "gray30"))
        ...
        self.create_label("Enter Youtube URL", 1)

        self.url_entry = customtkinter.CTkEntry(self, placeholder_text="YouTube URL", width=600, height=45)
        self.url_entry.grid(row=2, column=1, padx=(0, 0), pady=10, sticky="ew")

        self.create_label("Search path to save playlist", 3)

        self.path_entry = customtkinter.CTkEntry(self, placeholder_text="Path to save", width=600, height=45)
