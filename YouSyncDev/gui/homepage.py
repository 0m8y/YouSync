...
class HomePage(customtkinter.CTkFrame):
    def __init__(self, parent: customtkinter.CTk, image_path: str, **kwargs: Any):
        ...
        self.parent: customtkinter.CTk = parent
        super().__init__(parent, **kwargs)
    ...
    def __create_youtube_button__(self) -> None:
    ...
    def __create_spotify_button__(self) -> None:
    ...
    def __create_apple_button__(self) -> None:
    ...
    def __create_soundcloud_button__(self) -> None:
    ...
    def spotify_button_event(self) -> None:
        self.parent.show_new_spotify_playlist()

    def apple_button_event(self) -> None:
